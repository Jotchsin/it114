                    ...
                    <form action="{{ route('customer.save') }}" method="POST">
                         ...
                         <div class="row mt-2 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">Specifiy the First Name here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-label" for="inp_ln">Last Name <b 
                                        class="text-danger">*</b></label>    
                                    <span class="form-note">Specifiy the Last Name here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-label" for="inp_email">Email <b 
                                        class="text-danger">*</b></label>    
                                    <span class="form-note">Specifiy the Email address here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                         ...
                         <div class="row mt-2 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">Specifiy the Phone number here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                         ...
                         <div class="row mt-2 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">Specifiy the Address here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                         ...
                         <div class="row mt-2 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">Specifiy the City here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                         ...
                         <div class="row mt-2 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">Specifiy the State here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                        ...
                        <!-- Postal Code -->
                         <div class="row mt-2 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-label" for="inp_postal">Postal</label>    
                                    <span class="form-note">Specifiy the Postal here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                         ...
                         <div class="row mt-2 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">Specifiy the Country here.</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-control-wrap">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-7">
                                <button type="submit" class="btn btn-primary btn-block">
                                    <em class="econ ni ni-save"></em>&ensp;
                                    Submit New Customer
                                </button>
                            </div>
                        </div>
